import { View, Text, Image, Modal, FlatList, TouchableOpacity, TouchableWithoutFeedback, StyleSheet } from 'react-native'
import React from 'react'
import { icons, images, COLORS, FONTS, SIZES } from '../../constants'
import { TextButton, FormInput, IconButton, CountryDropDown, Checkbox } from '../../components'
                                ...
                                renderItem={({ item }) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <Text style={{ flex: 1, marginLeft: 20, color: COLORS.dark }}>
                                                {item.name}
                                            </Text>
                                        </TouchableOpacity>
                                    )
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    />
                    <IconButton icon={icons.linkedin}
                        iconStyle={{
                            tintColor: COLORS.dark,
                        }}
                        containerStyle={{
